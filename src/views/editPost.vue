...
export default {
    ...
    async updateBlog() {
    const dataBase = db.collection('blogPosts').doc(this.path);
            ...
            docRef.put(this.file).on(
                ...
                async () => {
                    ...
                    try {
                        ...
                        await this.$store.dispatch('updateBlog',this.path);
